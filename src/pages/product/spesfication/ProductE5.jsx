  ...
  return (
    <>
      <table cellPadding="1" cellSpacing="1">
        <tr>
          <td colSpan="3"> Model </td> <td colSpan="2"> CPD20J </td>
          <td colSpan="2"> CPD25J </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colSpan="2"> Rated load（） </td> <td colSpan="2"> 2000 </td>
        ...
        <tr>
          ...
          <td colSpan="2"> 3865 </td> <td colSpan="2"> 3865 </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colSpan="2"> Overhang (FR)（mm） </td> <td colSpan="4"> 465 </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td> Full load（mm/s） </td> <td> 240 </td> <td> 280 </td>
          <td> 220 </td> <td> 280 </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td> Full load（mm/s） </td> <td colSpan="4"> 430 </td>
        </tr>
        <tr>
          <td> No load（mm/s） </td> <td colSpan="4"> 460 </td>
        </tr>
        <tr>
          <td colSpan="2"> Maximum gradeability（%） </td> <td> 15 </td>
          <td> 15 </td> <td> 15 </td> <td> 15 </td>
        </tr>
        <tr>
          <td rowSpan="4"> Dimensions </td> <td> Overall length </td>
          <td> Without forks（mm） </td> <td colSpan="4"> 2410 </td>
        </tr>
        <tr>
          <td colSpan="2"> Overall width（mm） </td> <td colSpan="4"> 1163 </td>
        </tr>
        <tr>
          <td colSpan="2">
            <br /> Mast height at maximum lift (with backrest)（mm）
          </td>
          <td colSpan="4"> 4030 </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td> Front wheel </td> <td colSpan="4"> 7.00-12-12PR </td>
        </tr>
        <tr>
          <td> Rear wheel </td> <td colSpan="4"> 18×7-8-14PR </td>
        </tr>
        <tr>
          <td colSpan="2"> Wheelbase（mm） </td> <td colSpan="4"> 1520 </td>
        </tr>
        <tr>
          <td> Tread </td> <td> Front wheel/rear wheel（mm） </td>
          <td colSpan="4"> 973/960 </td>
        </tr>
        <tr>
          <td> Self weight </td> <td> Without load（kg） </td>
          <td colSpan="2"> 3850 </td> <td colSpan="2"> 4190 </td>
        </tr>
        <tr>
        ...
        <tr>
          <td> Lifting（KW） </td> <td nowrap=""> 8.6 </td>
          <td nowrap=""> 12 </td> <td nowrap=""> 8.6 </td>
          <td nowrap=""> 12 </td>
        </tr>
        <tr>
