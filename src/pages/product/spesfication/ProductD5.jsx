    ...
    <>
      <table cellPadding="1" cellSpacing="1">
        ...
        <tr>
          ...
          <td> 1070×125×45 </td> <td> 1070×125×50 </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td nowrap=""> Full load（km/h） </td> <td> 19 </td> <td> 18 </td>
        </tr>
        <tr>
          <td nowrap=""> No load（km/h） </td> <td> 19.5 </td> <td> 18.5 </td>
        </tr>
        <tr>
          <td rowSpan="2">
            <br /> Maximum lift speed
          </td>
          <td nowrap=""> Full load（mm/s） </td> <td> 460 </td> <td> 430 </td>
        </tr>
        <tr>
          <td nowrap=""> No load（mm/s） </td> <td> 485 </td> <td> 460 </td>
        </tr>
        <tr>
          <td nowrap=""> Maximum drawbar pull </td> <td> Full load（KN） </td>
          <td nowrap=""> 21 </td> <td> 23.5 </td>
        </tr>
        <tr>
          <td colSpan="2" nowrap="">
        ...
        <tr>
          ...
          <td nowrap=""> Without forks（mm） </td> <td> 2740 </td>
          <td> 2805 </td>
        </tr>
        <tr>
          <td colSpan="2" nowrap="">
        ...
        <tr>
          ...
          <td nowrap=""> Without load（Kg） </td> <td> 4300 </td>
          <td> 4820 </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td nowrap=""> Model </td> <td> AK-C240PKJ-30 </td> <td> 4TNE98 </td>
        </tr>
        <tr>
          <td nowrap=""> Rated output（kw/r.p.m） </td>
          <td> 34.3～36.5/2500 </td> <td> 42.1/2300 </td>
        </tr>
        <tr>
          <td nowrap=""> Rated torque（Nm/r.p.m） </td> <td> 137.7/1800 </td>
          <td> 177.6～196.3/1700±100 </td>
        </tr>
        <tr>
          <td nowrap=""> Bore x stroke（mm） </td> <td> 86×102 </td>
          <td> 98×110 </td>
        </tr>
        <tr>
        ...
        <tr>
          <td nowrap=""> Displacement（L） </td> <td> 2.369 </td>
          <td> 3.319 </td>
        </tr>
        <tr>
          <td colSpan="2" nowrap="">
        ...
        <tr>
          ...
          <td> 6340/920 </td> <td> 7040/1080 </td>
        </tr>
        <tr>
          <td colSpan="2" nowrap="">
            Axle load distribution (no load) (FR/RR)（kg）
          </td>
          <td> 1700/2580 </td> <td> 1720/3100 </td>
        </tr>
      </table>
    </>
  );
